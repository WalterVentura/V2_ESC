...
void drv8323s_init(void)
{
    ...
    palSetPadMode(DRV8323S_SCK_GPIO, DRV8323S_SCK_PIN,
                  PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST);
    palSetPadMode(DRV8323S_CS_GPIO, DRV8323S_CS_PIN,
                  PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST);
    palSetPadMode(DRV8323S_MOSI_GPIO, DRV8323S_MOSI_PIN,
                  PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST);
    palSetPad(DRV8323S_MOSI_GPIO, DRV8323S_MOSI_PIN);
    palSetPad(DRV8323S_CS_GPIO, DRV8323S_CS_PIN);

#ifdef DRV8323S_CS_GPIO2
    palSetPadMode(DRV8323S_CS_GPIO2, DRV8323S_CS_PIN2,
                  PAL_MODE_OUTPUT_PUSHPULL | PAL_STM32_OSPEED_HIGHEST);
