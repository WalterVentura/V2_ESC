...
{
    float t1 =
        (1.0 / ((logf(NTC_RES(ADC_Value[ADC_IND_TEMP_MOS]) / 10000.0) / 3900.0) + (1.0 / 298.15)) -
         273.15);
    float t2 =
        (1.0 /
         ((logf(NTC_RES(ADC_Value[ADC_IND_TEMP_MOS_2]) / 10000.0) / 3900.0) + (1.0 / 298.15)) -
         273.15);
    float t3 =
        (1.0 /
         ((logf(NTC_RES(ADC_Value[ADC_IND_TEMP_MOS_3]) / 10000.0) / 3900.0) + (1.0 / 298.15)) -
         273.15);
    float res = 0.0;
