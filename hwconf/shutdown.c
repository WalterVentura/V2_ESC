...
void shutdown_init(void)
{
    ...
    chThdCreateStatic(shutdown_thread_wa, sizeof(shutdown_thread_wa), NORMALPRIO, shutdown_thread,
                      NULL);
    m_init_done = true;
}
...
void shutdown_init(void)
{
    chThdCreateStatic(shutdown_thread_wa, sizeof(shutdown_thread_wa), LOWPRIO, shutdown_thread,
                      NULL);
}
