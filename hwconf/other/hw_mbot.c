...
#define TEMP_FILTER_LEN 9
    ...
    for(;;)
    {
        ...
        ENABLE_MOS_TEMP1B();
        chThdSleepMicroseconds(400);
        ADC_Value[ADC_IND_TEMP_MOSB] = ADC_Value[ADC_IND_ADC_MUX];

        ENABLE_MOS_TEMP2B();
        chThdSleepMicroseconds(400);
        ADC_Value[ADC_IND_TEMP_MOSB_M2] = ADC_Value[ADC_IND_ADC_MUX];
    ...
    for(;;)
    {
        switch(switch_state)
        {
            ...
            case SWITCH_TURN_ON_DELAY_ACTIVE:
                ...
                // Not sure if this pause is actually needed
