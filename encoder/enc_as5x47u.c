...
#define AS5x47U_SPI_READ_ERRFL_MSG                      (AS5x47U_SPI_ERRFL_ADR | \
                                                         AS5x47U_SPI_READ_BIT)
#define AS5x47U_SPI_READ_DIAG_MSG                       (AS5x47U_SPI_DIAG_ADR | \
                                                         AS5x47U_SPI_READ_BIT)
#define AS5x47U_SPI_READ_MAGN_MSG                       (AS5x47U_SPI_MAGN_ADR | \
                                                         AS5x47U_SPI_READ_BIT)
...
static void AS5x47U_start_spi_exchange_precalc_crc(AS5x47U_config_t* cfg, uint16_t tx_data,
                                                   uint8_t tx_crc);
...
static uint8_t enc_as5x47u_crc8(const uint8_t* data, size_t len, const uint8_t inital)
{
    ...
    static const uint8_t crc8_lookup[] =
    {
        ...
        ,
