...
#define AS504x_SPI_READ_CLEAR_ERROR_MSG                (AS504x_SPI_CLEAR_ERROR_ADR | \
                                                        AS504x_SPI_READ_BIT)
...
static uint8_t AS504x_spi_transfer_err_check(spi_bb_state* sw_spi, uint16_t* in_buf,
...
static uint8_t AS504x_fetch_diag(AS504x_config_t* cfg)
{
    uint16_t recf[2], senf[2] =
    {
        AS504x_SPI_READ_DIAG_MSG,
