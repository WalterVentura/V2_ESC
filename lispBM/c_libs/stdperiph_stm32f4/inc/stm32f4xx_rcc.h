...
#define IS_RCC_PLLP_VALUE(VALUE)        (((VALUE) == 2) || ((VALUE) == 4) || ((VALUE) == 6) || \
                                         ((VALUE) == 8))
...
#define IS_RCC_PLLI2SP_VALUE(VALUE)     (((VALUE) == 2) || ((VALUE) == 4) || ((VALUE) == 6) || \
                                         ((VALUE) == 8))
#define IS_RCC_PLLSAIM_VALUE(VALUE)     ((VALUE) <= 63)
#endif /* STM32F446xx */
#define IS_RCC_PLLSAIN_VALUE(VALUE)     ((49 <= (VALUE)) && ((VALUE) <= 432))
#if defined(STM32F446xx) || defined(STM32F469_479xx)
#define IS_RCC_PLLSAIP_VALUE(VALUE)     (((VALUE) == 2) || ((VALUE) == 4) || ((VALUE) == 6) || \
                                         ((VALUE) == 8))
...
#define  RCC_SYSCLKSource_PLLCLK RCC_SYSCLKSource_PLLPCLK
    ...
    defined(STM32F401xx) || defined(STM32F410xx) || defined(STM32F411xE) || defined(STM32F469_479xx)
#define RCC_SYSCLKSource_HSI     ((uint32_t) 0x00000000)
#define RCC_SYSCLKSource_HSE     ((uint32_t) 0x00000001)
...
#endif \
    /* STM32F40_41xxx || STM32F427_437xx || STM32F429_439xx || STM32F401xx || STM32F410xx || STM32F411xE || STM32F469_479xx */
...
#define IS_RCC_LPTIM1_SOURCE(SOURCE) (((SOURCE) == RCC_LPTIM1CLKSOURCE_PCLK) || \
...
#define IS_RCC_I2SCLK_SOURCE(SOURCE) (((SOURCE) == RCC_I2SCLKSource_PLLI2S) || \
                                      ((SOURCE) == RCC_I2SCLKSource_Ext) ||    \
                                      ((SOURCE) == RCC_I2SCLKSource_PLL) ||    \
                                      ((SOURCE) == RCC_I2SCLKSource_HSI_HSE))
...
#define IS_RCC_SAICLK_SOURCE(SOURCE) (((SOURCE) == RCC_SAICLKSource_PLLSAI) || \
                                      ((SOURCE) == RCC_SAICLKSource_PLLI2S) || \
                                      ((SOURCE) == RCC_SAICLKSource_PLL) ||    \
                                      ((SOURCE) == RCC_SAICLKSource_HSI_HSE))
...
#define IS_RCC_SAI_INSTANCE(BUS) (((BUS) == RCC_SAIInstance_SAI1) || \
                                  ((BUS) == RCC_SAIInstance_SAI2))
...
#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || \
    defined(STM32F401xx) || defined(STM32F411xE) || defined(STM32F469_479xx)
...
#define IS_RCC_FMPI2C1_CLOCKSOURCE(SOURCE) (((SOURCE) == RCC_FMPI2C1CLKSource_APB1) ||   \
...
#define IS_RCC_FLAG(FLAG)               (((FLAG) == RCC_FLAG_HSIRDY) ||    \
...
#if defined(STM32F410xx) || defined(STM32F446xx) || defined(STM32F469_479xx)
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t PLLM, uint32_t PLLN, uint32_t PLLP,
                   uint32_t PLLQ, uint32_t PLLR);

#endif /* STM32F410xx || STM32F446xx || STM32F469_479xx */

#if defined(STM32F40_41xxx) || defined(STM32F427_437xx) || defined(STM32F429_439xx) || \
    defined(STM32F401xx) || defined(STM32F411xE)
void RCC_PLLConfig(uint32_t RCC_PLLSource, uint32_t PLLM, uint32_t PLLN, uint32_t PLLP,
                   uint32_t PLLQ);
...
#if defined(STM32F446xx)
void RCC_PLLI2SConfig(uint32_t PLLI2SM, uint32_t PLLI2SN, uint32_t PLLI2SP, uint32_t PLLI2SQ,
                      uint32_t PLLI2SR);
