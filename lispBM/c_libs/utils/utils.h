...
uint16_t utils_median_filter_uint16_run(uint16_t* buffer, unsigned int* buffer_index,
                                        unsigned int filter_len, uint16_t sample);
...
#define RADPS2RPM_f(rad_per_sec)                     ((rad_per_sec) * \
                                                      (float) (60.0 / (2.0 * M_PI)))
 ...
 */
#define UTILS_LP_FAST(value, sample,                                               \
                      filter_constant)               (value -= (filter_constant) * \
                                                               ((value) - (sample)))
