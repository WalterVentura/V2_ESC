...
void lbm_create_string_char_channel(lbm_string_channel_state_t* st, lbm_char_channel_t* chan,
                                    char* str)
{
    st->str = str;
...
void lbm_create_string_char_channel_size(lbm_string_channel_state_t* st, lbm_char_channel_t* chan,
