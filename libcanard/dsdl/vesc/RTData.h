...
extern
uint32_t vesc_RTData_encode_internal(vesc_RTData* source, void* msg_buf, uint32_t offset,
                                     uint8_t root_item, bool tao_enabled);

extern
int32_t vesc_RTData_decode_internal(const CanardRxTransfer* transfer, uint16_t payload_len,
                                    vesc_RTData* dest, uint8_t** dyn_arr_buf, int32_t offset,
                                    bool tao_enabled);
