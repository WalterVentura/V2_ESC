 ...
 */
uint32_t vesc_RTData_encode_internal(vesc_RTData* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
                                         root_item), bool tao_enabled)
{
    (void) tao_enabled;
 ...
 */
int32_t vesc_RTData_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                        payload_len), vesc_RTData* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                        dyn_arr_buf), int32_t offset, bool tao_enabled)
{
    (void) tao_enabled;
    int32_t ret = 0;
#ifndef CANARD_USE_FLOAT16_CAST
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t vesc_RTData_decode(const CanardRxTransfer* transfer, uint16_t payload_len,
                           vesc_RTData* dest, uint8_t** dyn_arr_buf, bool tao_enabled)
{
    ...
    ret =
        vesc_RTData_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset, tao_enabled);
