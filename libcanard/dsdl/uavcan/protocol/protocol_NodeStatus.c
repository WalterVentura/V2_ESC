 ...
 */
int32_t uavcan_protocol_NodeStatus_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                       payload_len), uavcan_protocol_NodeStatus* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                       dyn_arr_buf), int32_t offset)
{
    ...
    ret = canardDecodeScalar(transfer, (uint32_t) offset, 16, false,
                             (void*) &dest->vendor_specific_status_code);
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_NodeStatus_decode(const CanardRxTransfer* transfer, uint16_t payload_len,
                                          uavcan_protocol_NodeStatus* dest, uint8_t** dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_NodeStatus_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                     offset);
