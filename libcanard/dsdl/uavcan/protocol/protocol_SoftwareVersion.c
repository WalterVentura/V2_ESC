 ...
 */
uint32_t uavcan_protocol_SoftwareVersion_encode(uavcan_protocol_SoftwareVersion* source,
                                                void*                            msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_SoftwareVersion_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                            payload_len), uavcan_protocol_SoftwareVersion* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                            dyn_arr_buf), int32_t offset)
{
    ...
    ret = canardDecodeScalar(transfer, (uint32_t) offset, 8, false,
                             (void*) &dest->optional_field_flags);
                                               ...
                                               uint8_t**                        dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_SoftwareVersion_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                          offset);
