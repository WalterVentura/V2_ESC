 ...
 */
uint32_t uavcan_protocol_HardwareVersion_encode(uavcan_protocol_HardwareVersion* source,
                                                void*                            msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_HardwareVersion_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                            payload_len), uavcan_protocol_HardwareVersion* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                               ...
                                               uint8_t**                        dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_HardwareVersion_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                          offset);
