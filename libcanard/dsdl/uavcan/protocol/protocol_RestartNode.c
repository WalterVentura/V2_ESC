 ...
 */
uint32_t uavcan_protocol_RestartNodeRequest_encode_internal(
    uavcan_protocol_RestartNodeRequest* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
 ...
 */
uint32_t uavcan_protocol_RestartNodeRequest_encode(uavcan_protocol_RestartNodeRequest* source,
                                                   void*                               msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_RestartNodeRequest_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                               payload_len), uavcan_protocol_RestartNodeRequest* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                  ...
                                                  uint8_t**                           dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_RestartNodeRequest_decode_internal(transfer, payload_len, dest,
                                                             dyn_arr_buf, offset);
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_RestartNodeResponse_encode_internal(
    uavcan_protocol_RestartNodeResponse* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
 ...
 * @retval returns message length as bytes
 */
uint32_t uavcan_protocol_RestartNodeResponse_encode(uavcan_protocol_RestartNodeResponse* source,
                                                    void*                                msg_buf)
{
    uint32_t offset = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_RestartNodeResponse_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                                payload_len), uavcan_protocol_RestartNodeResponse* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                                dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;
                                                   ...
                                                   uint8_t**                            dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_RestartNodeResponse_decode_internal(transfer, payload_len, dest,
                                                              dyn_arr_buf, offset);
