...
extern
uint32_t uavcan_protocol_GetNodeInfoRequest_encode(uavcan_protocol_GetNodeInfoRequest* source,
                                                   void*                               msg_buf);

extern
int32_t uavcan_protocol_GetNodeInfoRequest_decode(const CanardRxTransfer*             transfer,
                                                  uint16_t                            payload_len,
                                                  uavcan_protocol_GetNodeInfoRequest* dest,
                                                  uint8_t**                           dyn_arr_buf);

extern
uint32_t uavcan_protocol_GetNodeInfoRequest_encode_internal(
    uavcan_protocol_GetNodeInfoRequest* source, void* msg_buf, uint32_t offset, uint8_t root_item);

extern
int32_t uavcan_protocol_GetNodeInfoRequest_decode_internal(const CanardRxTransfer* transfer,
                                                           uint16_t payload_len,
                                                           uavcan_protocol_GetNodeInfoRequest* dest,
...
uint32_t uavcan_protocol_GetNodeInfoResponse_encode_internal(
    uavcan_protocol_GetNodeInfoResponse* source, void* msg_buf, uint32_t offset, uint8_t root_item);

extern
int32_t uavcan_protocol_GetNodeInfoResponse_decode_internal(const CanardRxTransfer* transfer,
                                                            uint16_t payload_len,
                                                            uavcan_protocol_GetNodeInfoResponse* dest, uint8_t** dyn_arr_buf, int32_t offset);
