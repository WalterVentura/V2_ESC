 ...
 */
uint32_t uavcan_protocol_file_GetInfoRequest_encode_internal(
    uavcan_protocol_file_GetInfoRequest* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    // Compound
 ...
 */
uint32_t uavcan_protocol_file_GetInfoRequest_encode(uavcan_protocol_file_GetInfoRequest* source,
                                                    void*                                msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_file_GetInfoRequest_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                                payload_len), uavcan_protocol_file_GetInfoRequest* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                                dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;

    // Compound
    offset = uavcan_protocol_file_Path_decode_internal(transfer, payload_len, &dest->path,
                                                       dyn_arr_buf, offset);
                                                   ...
                                                   uint8_t**                            dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_file_GetInfoRequest_decode_internal(transfer, payload_len, dest,
                                                              dyn_arr_buf, offset);
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_file_GetInfoResponse_encode_internal(
    uavcan_protocol_file_GetInfoResponse* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
 ...
 * @retval returns message length as bytes
 */
uint32_t uavcan_protocol_file_GetInfoResponse_encode(uavcan_protocol_file_GetInfoResponse* source,
                                                     void*                                 msg_buf)
{
    uint32_t offset = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_GetInfoResponse_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                                 payload_len), uavcan_protocol_file_GetInfoResponse* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                                 dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;
                                                    ...
                                                    uint8_t**                             dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_file_GetInfoResponse_decode_internal(transfer, payload_len, dest,
                                                               dyn_arr_buf, offset);
