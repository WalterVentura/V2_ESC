...
uint32_t uavcan_protocol_file_ReadRequest_encode_internal(uavcan_protocol_file_ReadRequest* source,
                                                          void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
                                                              root_item))
{
 ...
 */
uint32_t uavcan_protocol_file_ReadRequest_encode(uavcan_protocol_file_ReadRequest* source,
                                                 void*                             msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_file_ReadRequest_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                             payload_len), uavcan_protocol_file_ReadRequest* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                ...
                                                uint8_t**                         dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_file_ReadRequest_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                           offset);
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_file_ReadResponse_encode_internal(
    uavcan_protocol_file_ReadResponse* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    uint32_t c = 0;
 ...
 * @retval returns message length as bytes
 */
uint32_t uavcan_protocol_file_ReadResponse_encode(uavcan_protocol_file_ReadResponse* source,
                                                  void*                              msg_buf)
{
    uint32_t offset = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_ReadResponse_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                              payload_len), uavcan_protocol_file_ReadResponse* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                              dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;
    uint32_t c = 0;
                                                 ...
                                                 uint8_t**                          dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_file_ReadResponse_decode_internal(transfer, payload_len, dest,
                                                            dyn_arr_buf, offset);
