 ...
 */
uint32_t uavcan_protocol_file_Path_encode_internal(uavcan_protocol_file_Path* source, void* msg_buf,
                                                   uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
                                                       root_item))
{
    uint32_t c = 0;
 ...
 */
int32_t uavcan_protocol_file_Path_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                      payload_len), uavcan_protocol_file_Path* dest, uint8_t** CANARD_MAYBE_UNUSED(
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_Path_decode(const CanardRxTransfer* transfer, uint16_t payload_len,
                                         uavcan_protocol_file_Path* dest, uint8_t** dyn_arr_buf)
{
    ...
    ret =
        uavcan_protocol_file_Path_decode_internal(transfer, payload_len, dest, dyn_arr_buf, offset);
