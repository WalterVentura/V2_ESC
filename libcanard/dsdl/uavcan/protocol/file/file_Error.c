 ...
 */
int32_t uavcan_protocol_file_Error_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                       payload_len), uavcan_protocol_file_Error* dest, uint8_t** CANARD_MAYBE_UNUSED(
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_file_Error_decode(const CanardRxTransfer* transfer, uint16_t payload_len,
                                          uavcan_protocol_file_Error* dest, uint8_t** dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_file_Error_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                     offset);
