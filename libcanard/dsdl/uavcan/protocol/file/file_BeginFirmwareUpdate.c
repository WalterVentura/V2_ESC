 ...
 */
uint32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_encode_internal(
    uavcan_protocol_file_BeginFirmwareUpdateRequest* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    ...
    // Compound
    offset = uavcan_protocol_file_Path_encode_internal(&source->image_file_remote_path, msg_buf,
                                                       offset, 0);
 ...
 */
uint32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_encode(
    uavcan_protocol_file_BeginFirmwareUpdateRequest* source, void* msg_buf)
{
    uint32_t offset = 0;

    offset = uavcan_protocol_file_BeginFirmwareUpdateRequest_encode_internal(source, msg_buf,
                                                                             offset, 1);
...
int32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_decode_internal(
    const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
        payload_len), uavcan_protocol_file_BeginFirmwareUpdateRequest* dest, uint8_t** CANARD_MAYBE_UNUSED(
        dyn_arr_buf), int32_t offset)
{
    ...
    offset = uavcan_protocol_file_Path_decode_internal(transfer, payload_len,
                                                       &dest->image_file_remote_path, dyn_arr_buf,
                                                       offset);
...
int32_t uavcan_protocol_file_BeginFirmwareUpdateRequest_decode(const CanardRxTransfer* transfer,
                                                               ...
                                                               uavcan_protocol_file_BeginFirmwareUpdateRequest* dest, uint8_t** dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_file_BeginFirmwareUpdateRequest_decode_internal(transfer, payload_len,
                                                                          dest, dyn_arr_buf,
                                                                          offset);
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_encode_internal(
    uavcan_protocol_file_BeginFirmwareUpdateResponse* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    uint32_t c = 0;
 ...
 * @retval returns message length as bytes
 */
uint32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_encode(
    uavcan_protocol_file_BeginFirmwareUpdateResponse* source, void* msg_buf)
{
    uint32_t offset = 0;

    offset = uavcan_protocol_file_BeginFirmwareUpdateResponse_encode_internal(source, msg_buf,
                                                                              offset, 1);
...
int32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_decode_internal(
    const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
        payload_len), uavcan_protocol_file_BeginFirmwareUpdateResponse* dest, uint8_t** CANARD_MAYBE_UNUSED(
        dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;
    uint32_t c = 0;
...
int32_t uavcan_protocol_file_BeginFirmwareUpdateResponse_decode(const CanardRxTransfer* transfer,
                                                                uint16_t payload_len,
                                                                uavcan_protocol_file_BeginFirmwareUpdateResponse* dest, uint8_t** dyn_arr_buf)
{
    const int32_t offset = 0;
    int32_t ret = 0;
    ...
    ret = uavcan_protocol_file_BeginFirmwareUpdateResponse_decode_internal(transfer, payload_len,
                                                                           dest, dyn_arr_buf,
                                                                           offset);
