 ...
 */
uint32_t uavcan_protocol_param_ExecuteOpcodeRequest_encode_internal(
    uavcan_protocol_param_ExecuteOpcodeRequest* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
 ...
 */
uint32_t uavcan_protocol_param_ExecuteOpcodeRequest_encode(
    uavcan_protocol_param_ExecuteOpcodeRequest* source, void* msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_param_ExecuteOpcodeRequest_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                                       payload_len), uavcan_protocol_param_ExecuteOpcodeRequest* dest, uint8_t** CANARD_MAYBE_UNUSED(
...
int32_t uavcan_protocol_param_ExecuteOpcodeRequest_decode(const CanardRxTransfer* transfer,
                                                          ...
                                                          uavcan_protocol_param_ExecuteOpcodeRequest* dest, uint8_t** dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_param_ExecuteOpcodeRequest_decode_internal(transfer, payload_len, dest,
                                                                     dyn_arr_buf, offset);
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_param_ExecuteOpcodeResponse_encode_internal(
    uavcan_protocol_param_ExecuteOpcodeResponse* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    source->argument = CANARD_INTERNAL_SATURATE(source->argument, 140737488355327)
                       canardEncodeScalar(msg_buf, offset, 48, (void*) &source->argument); // 140737488355327
 ...
 * @retval returns message length as bytes
 */
uint32_t uavcan_protocol_param_ExecuteOpcodeResponse_encode(
    uavcan_protocol_param_ExecuteOpcodeResponse* source, void* msg_buf)
{
    uint32_t offset = 0;

    offset =
        uavcan_protocol_param_ExecuteOpcodeResponse_encode_internal(source, msg_buf, offset, 1);
...
int32_t uavcan_protocol_param_ExecuteOpcodeResponse_decode_internal(
    const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
        payload_len), uavcan_protocol_param_ExecuteOpcodeResponse* dest, uint8_t** CANARD_MAYBE_UNUSED(
        dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;
...
int32_t uavcan_protocol_param_ExecuteOpcodeResponse_decode(const CanardRxTransfer* transfer,
                                                           uint16_t payload_len,
                                                           uavcan_protocol_param_ExecuteOpcodeResponse* dest, uint8_t** dyn_arr_buf)
{
    const int32_t offset = 0;
    int32_t ret = 0;
    ...
    ret = uavcan_protocol_param_ExecuteOpcodeResponse_decode_internal(transfer, payload_len, dest,
                                                                      dyn_arr_buf, offset);
