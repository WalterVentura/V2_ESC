 ...
 */
int32_t uavcan_protocol_param_Value_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                        payload_len), uavcan_protocol_param_Value* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                        dyn_arr_buf), int32_t offset)
{
    ...
    {
        // Compound
        offset = uavcan_protocol_param_Empty_decode_internal(transfer, payload_len, &dest->empty,
                                                             dyn_arr_buf, offset);
    ...
    {
        ret =
            canardDecodeScalar(transfer, (uint32_t) offset, 64, true, (void*) &dest->integer_value);
    ...
    {
        ret =
            canardDecodeScalar(transfer, (uint32_t) offset, 8, false, (void*) &dest->boolean_value);
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_Value_decode(const CanardRxTransfer* transfer, uint16_t payload_len,
                                           uavcan_protocol_param_Value* dest, uint8_t** dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_param_Value_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                      offset);
