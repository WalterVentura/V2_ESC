 ...
 */
uint32_t uavcan_protocol_param_NumericValue_encode_internal(
    uavcan_protocol_param_NumericValue* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    // Max Union Tag Value
 ...
 */
uint32_t uavcan_protocol_param_NumericValue_encode(uavcan_protocol_param_NumericValue* source,
                                                   void*                               msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_param_NumericValue_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                               payload_len), uavcan_protocol_param_NumericValue* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                  ...
                                                  uint8_t**                           dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_param_NumericValue_decode_internal(transfer, payload_len, dest,
                                                             dyn_arr_buf, offset);
