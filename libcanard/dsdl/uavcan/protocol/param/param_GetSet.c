 ...
 */
uint32_t uavcan_protocol_param_GetSetRequest_encode_internal(
    uavcan_protocol_param_GetSetRequest* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    uint32_t c = 0;
 ...
 */
uint32_t uavcan_protocol_param_GetSetRequest_encode(uavcan_protocol_param_GetSetRequest* source,
                                                    void*                                msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_protocol_param_GetSetRequest_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                                payload_len), uavcan_protocol_param_GetSetRequest* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                                dyn_arr_buf), int32_t offset)
{
    ...
    // Compound
    offset = uavcan_protocol_param_Value_decode_internal(transfer, payload_len, &dest->value,
                                                         dyn_arr_buf, offset);
                                                   ...
                                                   uint8_t**                            dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_param_GetSetRequest_decode_internal(transfer, payload_len, dest,
                                                              dyn_arr_buf, offset);
 ...
 * @retval returns offset
 */
uint32_t uavcan_protocol_param_GetSetResponse_encode_internal(
    uavcan_protocol_param_GetSetResponse* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    uint32_t c = 0;
    ...
    // Compound
    offset =
        uavcan_protocol_param_Value_encode_internal(&source->default_value, msg_buf, offset, 0);

    // Void6
    offset += 6;

    // Compound
    offset = uavcan_protocol_param_NumericValue_encode_internal(&source->max_value, msg_buf, offset,
                                                                0);
    ...
    // Compound
    offset = uavcan_protocol_param_NumericValue_encode_internal(&source->min_value, msg_buf, offset,
                                                                0);
 ...
 * @retval returns message length as bytes
 */
uint32_t uavcan_protocol_param_GetSetResponse_encode(uavcan_protocol_param_GetSetResponse* source,
                                                     void*                                 msg_buf)
{
    uint32_t offset = 0;
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_protocol_param_GetSetResponse_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                                 payload_len), uavcan_protocol_param_GetSetResponse* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                                 dyn_arr_buf), int32_t offset)
{
    int32_t ret = 0;
    uint32_t c = 0;
    ...
    // Compound
    offset = uavcan_protocol_param_Value_decode_internal(transfer, payload_len,
    ...
    // Compound
    offset = uavcan_protocol_param_NumericValue_decode_internal(transfer, payload_len,
                                                                &dest->max_value, dyn_arr_buf,
                                                                offset);
                                                    ...
                                                    uint8_t**                             dyn_arr_buf)
{
    ...
    ret = uavcan_protocol_param_GetSetResponse_decode_internal(transfer, payload_len, dest,
                                                               dyn_arr_buf, offset);
