...
extern
int32_t uavcan_protocol_param_Empty_decode(const CanardRxTransfer* transfer, uint16_t payload_len,
                                           uavcan_protocol_param_Empty* dest,
                                           uint8_t** dyn_arr_buf);

extern
uint32_t uavcan_protocol_param_Empty_encode_internal(uavcan_protocol_param_Empty* source,
                                                     void* msg_buf, uint32_t offset,
                                                     uint8_t root_item);

extern
int32_t uavcan_protocol_param_Empty_decode_internal(const CanardRxTransfer* transfer,
