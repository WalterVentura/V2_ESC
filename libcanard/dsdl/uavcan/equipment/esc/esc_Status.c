                                                         ...
                                                         root_item))
{
    ...
    source->power_rating_pct = CANARD_INTERNAL_SATURATE_UNSIGNED(source->power_rating_pct, 127)
                               canardEncodeScalar(msg_buf, offset, 7,
                                                  (void*) &source->power_rating_pct); // 127
    offset += 7;
 ...
 */
int32_t uavcan_equipment_esc_Status_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                        payload_len), uavcan_equipment_esc_Status* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                        dyn_arr_buf), int32_t offset)
{
    ...
    ret =
        canardDecodeScalar(transfer, (uint32_t) offset, 7, false, (void*) &dest->power_rating_pct);
 ...
 * @retval offset or ERROR value if < 0
 */
int32_t uavcan_equipment_esc_Status_decode(const CanardRxTransfer* transfer, uint16_t payload_len,
                                           uavcan_equipment_esc_Status* dest, uint8_t** dyn_arr_buf)
{
    ...
    ret = uavcan_equipment_esc_Status_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                      offset);
