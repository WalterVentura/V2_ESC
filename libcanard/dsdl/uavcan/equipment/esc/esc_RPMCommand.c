 ...
 */
uint32_t uavcan_equipment_esc_RPMCommand_encode(uavcan_equipment_esc_RPMCommand* source,
                                                void*                            msg_buf)
{
    uint32_t offset = 0;

    offset = uavcan_equipment_esc_RPMCommand_encode_internal(source, msg_buf, offset, 1);
 ...
 */
int32_t uavcan_equipment_esc_RPMCommand_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                            payload_len), uavcan_equipment_esc_RPMCommand* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                               ...
                                               uint8_t**                        dyn_arr_buf)
{
    ...
    ret = uavcan_equipment_esc_RPMCommand_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                          offset);
