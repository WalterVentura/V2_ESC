 ...
 */
int32_t uavcan_equipment_esc_RawCommand_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                            payload_len), uavcan_equipment_esc_RawCommand* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                               ...
                                               uint8_t**                        dyn_arr_buf)
{
    ...
    ret = uavcan_equipment_esc_RawCommand_decode_internal(transfer, payload_len, dest, dyn_arr_buf,
                                                          offset);
