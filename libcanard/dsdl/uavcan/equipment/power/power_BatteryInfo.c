 ...
 */
uint32_t uavcan_equipment_power_BatteryInfo_encode_internal(
    uavcan_equipment_power_BatteryInfo* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
    uint32_t c = 0;
    ...
    source->state_of_charge_pct_stdev = CANARD_INTERNAL_SATURATE_UNSIGNED(
        source->state_of_charge_pct_stdev, 127)
                                        canardEncodeScalar(msg_buf, offset, 7,
                                                           (void*) &source->state_of_charge_pct_stdev); // 127
    offset += 7;
 ...
 */
uint32_t uavcan_equipment_power_BatteryInfo_encode(uavcan_equipment_power_BatteryInfo* source,
                                                   void*                               msg_buf)
{
    uint32_t offset = 0;
 ...
 */
int32_t uavcan_equipment_power_BatteryInfo_decode_internal(const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
                                                               payload_len), uavcan_equipment_power_BatteryInfo* dest, uint8_t** CANARD_MAYBE_UNUSED(
                                                  ...
                                                  uint8_t**                           dyn_arr_buf)
{
    ...
    while(1)
    {
        ...
        ret = uavcan_equipment_power_BatteryInfo_decode_internal(transfer, payload_len, dest,
