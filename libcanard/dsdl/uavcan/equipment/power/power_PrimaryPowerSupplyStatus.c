 ...
 */
uint32_t uavcan_equipment_power_PrimaryPowerSupplyStatus_encode_internal(
    uavcan_equipment_power_PrimaryPowerSupplyStatus* source, void* msg_buf, uint32_t offset, uint8_t CANARD_MAYBE_UNUSED(
        root_item))
{
...
#ifndef CANARD_USE_FLOAT16_CAST
    tmp_float =
        canardConvertNativeFloatToFloat16(source->hours_to_empty_at_10sec_avg_power_variance);
#else
    tmp_float = (CANARD_USE_FLOAT16_CAST) source->hours_to_empty_at_10sec_avg_power_variance;
#endif
    canardEncodeScalar(msg_buf, offset, 16, (void*) &tmp_float); // 32767
    offset += 16;
    source->external_power_available = CANARD_INTERNAL_SATURATE_UNSIGNED(
        source->external_power_available, 0)
                                       canardEncodeScalar(msg_buf, offset, 1,
                                                          (void*) &source->external_power_available); // 0
    offset += 1;

    source->remaining_energy_pct = CANARD_INTERNAL_SATURATE_UNSIGNED(source->remaining_energy_pct,
                                                                     127)
                                   canardEncodeScalar(msg_buf, offset, 7,
                                                      (void*) &source->remaining_energy_pct); // 127
    offset += 7;

    source->remaining_energy_pct_stdev = CANARD_INTERNAL_SATURATE_UNSIGNED(
        source->remaining_energy_pct_stdev, 127)
                                         canardEncodeScalar(msg_buf, offset, 7,
                                                            (void*) &source->remaining_energy_pct_stdev); // 127
    offset += 7;
 ...
 */
uint32_t uavcan_equipment_power_PrimaryPowerSupplyStatus_encode(
    uavcan_equipment_power_PrimaryPowerSupplyStatus* source, void* msg_buf)
{
    uint32_t offset = 0;

    offset = uavcan_equipment_power_PrimaryPowerSupplyStatus_encode_internal(source, msg_buf,
                                                                             offset, 1);
...
int32_t uavcan_equipment_power_PrimaryPowerSupplyStatus_decode_internal(
    const CanardRxTransfer* transfer, uint16_t CANARD_MAYBE_UNUSED(
        payload_len), uavcan_equipment_power_PrimaryPowerSupplyStatus* dest, uint8_t** CANARD_MAYBE_UNUSED(
...
int32_t uavcan_equipment_power_PrimaryPowerSupplyStatus_decode(const CanardRxTransfer* transfer,
                                                               ...
                                                               uavcan_equipment_power_PrimaryPowerSupplyStatus* dest, uint8_t** dyn_arr_buf)
{
    ...
    while(1)
    {
        ...
        ret = uavcan_equipment_power_PrimaryPowerSupplyStatus_decode_internal(transfer, payload_len,
                                                                              dest, dyn_arr_buf,
                                                                              offset, tao);
