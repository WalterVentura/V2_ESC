...
static int stm32l4_flash_write(struct target_flash* f, target_addr dest, const void* src,
                               size_t len);
...
static void stm32l4_add_flash(target* t, uint32_t addr, size_t length, size_t blocksize,
                              uint32_t bank1_start)
{
...
static bool stm32l4_attach(target* t)
{
    ...
    target_mem_write32(t, DBGMCU_CR(
                           idcodereg),
