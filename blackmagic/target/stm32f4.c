...
static int stm32f4_flash_write(struct target_flash* f, target_addr dest, const void* src,
                               size_t len);
...
static void stm32f4_add_flash(target* t, uint32_t addr, size_t length, size_t blocksize,
