...
void commands_init(void)
{
    ...
    chThdCreateStatic(blocking_thread_wa, sizeof(blocking_thread_wa), NORMALPRIO, blocking_thread,
                      NULL);
    is_initialized = true;
}
    ...
    switch(packet_id)
    {
        ...
        case COMM_WRITE_NEW_APP_DATA_ALL_CAN:
            ...
            if(packet_id == COMM_WRITE_NEW_APP_DATA_ALL_CAN_LZO)
            {
                ...
                lzo1x_decompress_safe(send_buffer_global, len - 6, data + 4, &decompressed_len,
                                      NULL);
        ...
        case COMM_WRITE_NEW_APP_DATA:
        {
            ...
            uint16_t flash_res = flash_helper_write_new_app_data(new_app_offset, data + ind,
                                                                 len - ind);
        ...
        case COMM_GET_VALUES_SELECTIVE:
        {
            ...
            {
                buffer_append_float32(send_buffer,
                                      mc_interface_read_reset_avg_motor_current(), 1e2, &ind);
            }

            if(mask & ((uint32_t) 1 << 3))
            {
                buffer_append_float32(send_buffer,
                                      mc_interface_read_reset_avg_input_current(), 1e2, &ind);
            }
            ...
            {
                buffer_append_float16(send_buffer,
                                      mc_interface_get_input_voltage_filtered(), 1e1, &ind);
            }
            ...
            {
                buffer_append_float32(send_buffer, mc_interface_get_amp_hours_charged(
                                          false), 1e4, &ind);
            }
            ...
            {
                buffer_append_float32(send_buffer, mc_interface_get_watt_hours_charged(
                                          false), 1e4, &ind);
            }
            ...
            {
                buffer_append_int32(send_buffer, mc_interface_get_tachometer_abs_value(false),
                                    &ind);
            }
        ...
        case COMM_GET_MCCONF_DEFAULT:
        {
            ...
            else
            {
                ...
                mcconf->foc_offsets_voltage_undriven[0] =
                    mcconf_now->foc_offsets_voltage_undriven[0];
                mcconf->foc_offsets_voltage_undriven[1] =
                    mcconf_now->foc_offsets_voltage_undriven[1];
                mcconf->foc_offsets_voltage_undriven[2] =
                    mcconf_now->foc_offsets_voltage_undriven[2];
            }
        ...
        case COMM_GET_DECODED_PPM:
        {
            ...
            buffer_append_int32(send_buffer,
                                (int32_t) (app_ppm_get_decoded_level() * 1000000.0), &ind);
            buffer_append_int32(send_buffer, (int32_t) (servodec_get_last_pulse_len(
                                                            0) * 1000000.0), &ind);
            reply_func(send_buffer, ind);
        } break;
        ...
        case COMM_GET_DECODED_ADC:
        {
            ...
            buffer_append_int32(send_buffer,
                                (int32_t) (app_adc_get_decoded_level() * 1000000.0), &ind);
            buffer_append_int32(send_buffer, (int32_t) (app_adc_get_voltage() * 1000000.0), &ind);
            buffer_append_int32(send_buffer,
                                (int32_t) (app_adc_get_decoded_level2() * 1000000.0), &ind);
        ...
        case COMM_GET_DECODED_CHUK:
        {
            ...
            buffer_append_int32(send_buffer,
                                (int32_t) (app_nunchuk_get_decoded_y() * 1000000.0), &ind);
            reply_func(send_buffer, ind);
        } break;
        ...
        case COMM_GET_VALUES_SETUP_SELECTIVE:
        {
            ...
            if(mask & ((uint32_t) 1 << 21))
            {
                buffer_append_uint32(send_buffer,
                                     chVTGetSystemTimeX() / (CH_CFG_ST_FREQUENCY / 1000), &ind);
            }
        ...
        case COMM_LISP_ERASE_CODE:
        {
            ...
            uint16_t flash_res = flash_helper_erase_code(
                packet_id == COMM_QMLUI_ERASE ? CODE_IND_QML : CODE_IND_LISP);
        ...
        case COMM_LISP_WRITE_CODE:
        {
            ...
            uint16_t flash_res = flash_helper_write_code(
                packet_id == COMM_QMLUI_WRITE ? CODE_IND_QML : CODE_IND_LISP,
...
void commands_send_mcconf(COMM_PACKET_ID packet_id, mc_configuration* mcconf, void (* reply_func)(
                              unsigned char* data, unsigned int len))
{
    uint8_t* send_buffer_global = mempools_get_packet_buffer();
...
void commands_send_appconf(COMM_PACKET_ID packet_id, app_configuration* appconf, void (* reply_func)(
                               unsigned char* data,
                               unsigned int len))
{
    uint8_t* send_buffer_global = mempools_get_packet_buffer();
        ...
        switch(packet_id)
        {
            case COMM_DETECT_MOTOR_PARAM:
            {
                ...
                if(!conf_general_detect_motor_param(detect_current, detect_min_rpm,
                                                    detect_low_duty, &detect_cycle_int_limit,
                                                    &detect_coupling_k,
            ...
            case COMM_DETECT_MOTOR_FLUX_LINKAGE:
            {
                ...
                float linkage;
                bool res = conf_general_measure_flux_linkage(current, duty, min_rpm, resistance,
                                                             &linkage);
            ...
            case COMM_DETECT_MOTOR_FLUX_LINKAGE_OPENLOOP:
            {
                ...
                int fault = conf_general_measure_flux_linkage_openloop(current, duty,
                                                                       erpm_per_sec, resistance,
                                                                       inductance,
                                                                       &linkage, &linkage_undriven,
                                                                       &undriven_samples, &res);
