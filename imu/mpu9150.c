...
static THD_FUNCTION(mpu_thread, arg)
{
    ...
    for(;;)
    {
        ...
        if(get_raw_accel_gyro(raw_accel_gyro_mag_tmp))
        {
            ...
            {
                memcpy((uint16_t*) raw_accel_gyro_mag_no_offset, raw_accel_gyro_mag_tmp,
                       sizeof(raw_accel_gyro_mag));
                ...
                memcpy((uint16_t*) raw_accel_gyro_mag, raw_accel_gyro_mag_tmp,
                       sizeof(raw_accel_gyro_mag));
                ...
                if(use_magnetometer)
                {
                    ...
                    if(mag_cnt >= MAG_DIV)
                    {
                        ...
                        {
                            memcpy((uint16_t*) raw_accel_gyro_mag_tmp + 6, raw_mag_tmp,
                                   sizeof(raw_mag_tmp));
                        }
                        else
                        {
