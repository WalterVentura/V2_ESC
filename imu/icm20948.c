...
void icm20948_init(ICM20948_STATE* s, i2c_bb_state* i2c_state, int ad0_val, stkalign_t* work_area,
...
void icm20948_set_read_callback(ICM20948_STATE* s, void (* func)(float* accel, float* gyro,
                                                                 float* mag))
{
...
static THD_FUNCTION(icm_thread, arg)
{
    ...
    for(;;)
    {
        ...
        if(res)
        {
            ...
            accel[0] =
                (float) ((int16_t) ((int16_t) rxb[0] << 8 | (int16_t) rxb[1])) * 16.0 / 32768.0;
            accel[1] =
                (float) ((int16_t) ((int16_t) rxb[2] << 8 | (int16_t) rxb[3])) * 16.0 / 32768.0;
            accel[2] =
                (float) ((int16_t) ((int16_t) rxb[4] << 8 | (int16_t) rxb[5])) * 16.0 / 32768.0;

            gyro[0] =
                (float) ((int16_t) ((int16_t) rxb[6] << 8 | (int16_t) rxb[7])) * 2000.0 / 32768.0;
            gyro[1] =
                (float) ((int16_t) ((int16_t) rxb[8] << 8 | (int16_t) rxb[9])) * 2000.0 / 32768.0;
            gyro[2] =
                (float) ((int16_t) ((int16_t) rxb[10] << 8 | (int16_t) rxb[11])) * 2000.0 / 32768.0;
