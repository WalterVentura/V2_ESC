...
#define IS_OB_WRP(SECTOR) ((((SECTOR) &(uint32_t) 0xFFFFF000) == 0x00000000) && \
                           ((SECTOR) != 0x00000000))
...
#define IS_OB_PCROP(SECTOR) ((((SECTOR) &(uint32_t) 0xFFFFF000) == 0x00000000) && \
                             ((SECTOR) != 0x00000000))
...
#define IS_FLASH_CLEAR_FLAG(FLAG) ((((FLAG) &(uint32_t) 0xFFFFFE0C) == 0x00000000) && \
                                   ((FLAG) != 0x00000000))
