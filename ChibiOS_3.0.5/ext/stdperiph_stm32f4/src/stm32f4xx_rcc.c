...
#define RCC_CFGR_MCO1EN_BB    (PERIPH_BB_BASE + (RCC_CFGR_OFFSET * 32) + \
                               (RCC_MCO1EN_BIT_NUMBER * 4))

/* Alias word address of MCO2EN bit */
#define RCC_MCO2EN_BIT_NUMBER 0x9
#define RCC_CFGR_MCO2EN_BB    (PERIPH_BB_BASE + (RCC_CFGR_OFFSET * 32) + \
                               (RCC_MCO2EN_BIT_NUMBER * 4))
#endif /* STM32F410xx */
...
#endif \
    /* STM32F40_41xxx || STM32F427_437xx || STM32F429_439xx || STM32F401xx || STM32F411xE || STM32F446xx || STM32F469_479xx */
                      ...
                      uint32_t PLLI2SR)
{
    ...
    RCC->PLLI2SCFGR = PLLI2SM |
                      (PLLI2SN <<
                       6) | (((PLLI2SP >> 1) - 1) << 16) | (PLLI2SQ << 24) | (PLLI2SR << 28);
}
