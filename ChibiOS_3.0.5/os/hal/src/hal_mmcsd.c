...
void _mmcsd_unpack_csd_mmc(const MMCSDBlockDevice* sdcp, unpacked_mmc_csd_t* csdmmc)
{
    ...
    csdmmc->perm_write_protect = (uint8_t) _mmcsd_get_slice(csd,
    ...
    csdmmc->read_blk_misalign = (uint8_t) _mmcsd_get_slice(csd,
    ...
    csdmmc->tmp_write_protect = (uint8_t) _mmcsd_get_slice(csd,
    ...
    csdmmc->write_bl_partial =
        (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_MMC_WRITE_BL_PARTIAL_SLICE);
    csdmmc->write_blk_misalign = (uint8_t) _mmcsd_get_slice(csd,
...
void _mmcsd_unpack_csd_v10(const MMCSDBlockDevice* sdcp, unpacked_sdc_csd_10_t* csd10)
{
    ...
    csd10->erase_sector_size =
        (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_10_ERASE_SECTOR_SIZE_SLICE);
    ...
    csd10->perm_write_protect = (uint8_t) _mmcsd_get_slice(csd,
    ...
    csd10->read_blk_misalign =
        (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_10_READ_BLK_MISALIGN_SLICE);
    csd10->taac = (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_10_TAAC_SLICE);
    csd10->tmp_write_protect =
        (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_10_TMP_WRITE_PROTECT_SLICE);
    ...
    csd10->write_blk_misalign = (uint8_t) _mmcsd_get_slice(csd,
...
void _mmcsd_unpack_csd_v20(const MMCSDBlockDevice* sdcp, unpacked_sdc_csd_20_t* csd20)
{
    ...
    csd20->perm_write_protect = (uint8_t) _mmcsd_get_slice(csd,
    ...
    csd20->read_blk_misalign =
        (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_20_READ_BLK_MISALIGN_SLICE);
    csd20->erase_sector_size =
        (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_20_ERASE_SECTOR_SIZE_SLICE);
    csd20->taac = (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_20_TAAC_SLICE);
    csd20->tmp_write_protect =
        (uint8_t) _mmcsd_get_slice(csd, MMCSD_CSD_20_TMP_WRITE_PROTECT_SLICE);
    ...
    csd20->write_blk_misalign = (uint8_t) _mmcsd_get_slice(csd,
