 ...
 * @notapi
 */
static void otg_fifo_write_from_buffer(volatile uint32_t* fifop, const uint8_t* buf, size_t n)
{
 ...
 * @notapi
 */
static void otg_fifo_write_from_queue(volatile uint32_t* fifop, output_queue_t* oqp, size_t n)
{
    size_t ntogo;
 ...
 * @notapi
 */
static void otg_fifo_read_to_buffer(volatile uint32_t* fifop, uint8_t* buf, size_t n, size_t max)
{
    n = (n + 3) / 4;
    max = (max + 3) / 4;
 ...
 * @notapi
 */
static void otg_fifo_read_to_queue(volatile uint32_t* fifop, input_queue_t* iqp, size_t n)
{
    size_t ntogo;
