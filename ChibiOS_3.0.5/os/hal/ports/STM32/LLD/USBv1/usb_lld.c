 ...
 * @notapi
 */
static void usb_packet_read_to_buffer(stm32_usb_descriptor_t* udp, uint8_t* buf, size_t n)
{
 ...
 * @notapi
 */
static void usb_packet_read_to_queue(stm32_usb_descriptor_t* udp, input_queue_t* iqp, size_t n)
{
    size_t nhw;
 ...
 * @notapi
 */
static void usb_packet_write_from_buffer(stm32_usb_descriptor_t* udp, const uint8_t* buf, size_t n)
{
    uint32_t w;
    size_t i;
    stm32_usb_pma_t* pmap;
 ...
 * @notapi
 */
static void usb_packet_write_from_queue(stm32_usb_descriptor_t* udp, output_queue_t* oqp, size_t n)
{
    size_t nhw;
    syssts_t sts;
