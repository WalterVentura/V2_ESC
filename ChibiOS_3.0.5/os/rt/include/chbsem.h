 ...
 * @sclass
 */
static inline msg_t chBSemWaitTimeoutS(binary_semaphore_t* bsp, systime_t time)
{
    chDbgCheckClassS();
 ...
 * @api
 */
static inline msg_t chBSemWaitTimeout(binary_semaphore_t* bsp, systime_t time)
{
